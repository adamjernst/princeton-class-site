...
DATABASE_NAME = os.path.join(PROJECT_PATH, 'cms.sqlite') # Or path to database file if using sqlite3.
...
SECRET_KEY = '9_*%b0#16ntd%b&z+&4xc-k&w0*y@gvsr08zfh@k!_#vp8nna&'
